                                ...
                                ?>
                                    ...
                                    <tr class="text-center align-middle">
                                        ...
                                        <td><a href="doctor-del.php">
                                                <div class="btn btn-sm btn-danger doctor-del-btn" title="<?= $doc['doctor_id'] ?>" id="<?php echo $doc['doctor_id'] ?>">Delete
                                                </div>
                                            </a></td>
                                    </tr>
                                <?php endforeach ?>
                                ...
                                ?>
                                    ...
                                    <tr class="text-center align-middle">
                                        ...
                                        <td><a href="user-del.php">
                                                <div class="btn btn-sm btn-danger user-del-btn" title="<?= $user['user_id'] ?>" id="<?php echo $user['user_id'] ?>">Delete</div>
                                            </a></td>
