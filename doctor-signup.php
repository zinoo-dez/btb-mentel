...
<div class="container p-5">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="w-50 m-auto p-5 shadow-lg"
        ...
        <div class="mb-3">
            ...
            <textarea placeholder="Type Your Address" name="address" id="address" class="form-control"> </textarea>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input placeholder="Type Your Department" type="text" name="department" id="department"
                class="form-control">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input placeholder="Type Your Position" type="text" name="position" id="position" class="form-control">
        </div>
        <div class="mb-3">
